...
def main():
    ...
    # 4) Stage
    writer.write_to_staging(df2, "project-b553234c-bfd7-4957-88b", "product_dwh", "dim_products_staging")
    # 5) Merge
    writer.merge_scd2_bq(spark, "project-b553234c-bfd7-4957-88b", "product_dwh", "dim_products_staging", "dim_products")
    # 6) Archive
